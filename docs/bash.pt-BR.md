...
**Português (BR)** · [English](bash.en.md)

Cada entrada abaixo é o cabeçalho do próprio script — o mesmo texto que o `-h` imprime, em inglês — para que esta página não possa descrever um script de forma diferente do script. Gerada por [`tools/gen-docs.sh`](../tools/gen-docs.sh); edite o cabeçalho do script, não este arquivo.
